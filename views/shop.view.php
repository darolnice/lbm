            ...
            <article>
                <div class="blg_f_div">
                    ...
                    <div class="srtby">
                        ...
                        <h6>Price
                            <div class="barometre" data-level="10">
                                <div class="pointer">
                                    <h2 data-position="0" class="state_price">$500</h2>
                                    <h3 class="frst_price">$1</h3>
                                    <h4 class="illimitate">8</h4>
                                </div>
                            </div>
                        </h6>
                ...
                <div class="avis">
                    <a>COMMENT'S</a>
                    <?php for ($p=0; $p<4; $p++):?>
                        <img src="<?= S_ASSETS?>images/lite.jpg" alt="lite">
                        <h6>Darol</h6>
