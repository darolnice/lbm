...
<body>
    ...
    <section id="home_pre_sec1">
        <img id="img1_pre_sec1" src="<?= S_ASSETS;?>images/question-marks.jpg" alt="investir">
    ...
    <section class="container" id="pre_sec2">
        ...
        <div id="pre_depot_detail">
            <div id="pre_xpl">
                <img class="bnk" src="<?= S_ASSETS?>images/lite.jpg" alt="project_lis2">
            </div>
        ...
        <?php if($this->getProfilData()[$t]['comments'] !== null): ?>
            ...
            <?php $cmm_ = array_reverse(json_decode($this->getProfilData()[$t]['comments'], true))?>
                <?php foreach ($cmm_ as $cm):?>
                    <div id="ctn">
                        <img id="res1_img" src="<?= S_ASSETS?>images/lite.jpg" alt="person">
    ...
    <section class="container reveal-1" id="home_sec8">
        ...
        <div id="sec8_serv">
            <div class="flex-lg-wrap" id="tl1">
                ...
                <img id="sec8_img1_qg" src="<?= S_ASSETS?>images/lite.jpg" alt="loggo">
            ...
            <div class="flex-lg-wrap" id="tl2">
                ...
                <img id="sec8_img2_qg" src="<?= S_ASSETS?>images/lite.jpg" alt="loggo">
            ...
            <div class="flex-lg-wrap" id="tl3">
                ...
                <img id="sec8_img3_qg" src="<?= S_ASSETS?>images/lite.jpg" alt="loggo">
