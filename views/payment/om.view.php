...
<body>
<div class="container" style="border:1px solid rgba(255, 165, 0, 0.68)">
    <h6>BUY WITH ORANGE MONEY</h6>
    <div class="momo__">
        <img src="<?= S_ASSETS?>images/img/lite.jpg" alt="mtn mobile money logo">
