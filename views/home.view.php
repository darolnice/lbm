    ...
    <section class="scn1">
        <div class="diapo">
            <div class="elements">
                <div class="div_pub">
                    <div class="div_1">
                        <img src="<?= S_ASSETS?>images/img/question-marks.jpg" alt="product">
                        <div class="caption">
                            <h1>image 1</h1>
                ...
                <div class="div_pub">
                    <div class="div_2">
                        <img src="<?= S_ASSETS?>images/img/lite.jpg" alt="product">
                        <div class="caption">
                            <h1>image 2</h1>
                            <p>Lorem ipsum dolor sit amet, repudiandae?</p>
                        </div>
                ...
                <div class="div_pub">
                    <div class="div_3">
                        <img src="<?= S_ASSETS?>images/img/dev.jpg" alt="product">
                        <div class="caption">
                            <h1>image 3</h1>
                            <p>Lorem ipsum dolor sit amet, repudiandae?</p>
                        </div>
