                            ...
                            <div class="f_list">
                                ...
                                <?php for($t=0; $t<count($this->getAllinFaq()); $t++): ?>
                                    <div class="F_item">
                                        ...
                                        <img id="faq_ed" src="<?= S_ASSETS ?>images/edit.png" alt="Edit button">
                            ...
                            <div class="plan_list">
                                ...
                                <?php for($s_=0; $s_<count($this->getAllplan()); $s_++): ?>
                                    <div class="plan_item">
                                        ...
                                        <img id="plan_del" class="mt-5" src="<?= S_ASSETS ?>images/trash.png" alt="Edit button">
                                        <img id="plan_ed" src="<?= S_ASSETS ?>images/edit.png" alt="Edit button">
                        ...
                        <div class="custumer_l" style="display: none">
                            ...
                            <div class="custList" style="display: none">
                                ...
                                <div class="allcustlist" style="display: none">
                                    <ul>
                                        <?php for($li=0; $li<count($this->getBusiClient()); $li++): ?>
                                            <li data-pid="<?= $this->getBusiClient()[$li]['id']?>" class="list-group-item">
                                                <span>
                                                    <b>Name : </b><a><?= $this->getBusiClient()[$li]['username']?></a>
                                                    <b>Country : </b><a><?= $this->getBusiClient()[$li]['country']?></a>
                                                    <b>City : </b><a><?= $this->getBusiClient()[$li]['city']?></a>
                                                </span>
                                            </li>
                                        <?php endfor;?>
                                    </ul>
